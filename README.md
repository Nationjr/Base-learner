...
👛 Download Coinbase Wallet : https://chromewebstore.google.com/detail/coinbase-wallet-extension/hnfanknocfeofbddgcijnmhnfnkdnaad

🏛 Base Guild : https://era.guild.xyz/base (Select Base Program)

### ‼️Note : You can create a new file or replace previous file to make it faster complete task
